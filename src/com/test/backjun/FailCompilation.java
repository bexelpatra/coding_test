...
public class FailCompilation {
    public static void main(String[] args) {
        ...
        String[] failList = new String[] { "16236", "2206", "10158", "2565", "1309", "11049", "1967", "13164", "2138",
                "10971", "10972", "1057", "2470", "1629" ,"3015","b_4179","15991","2240","9084"};
        String[] failListReason = new String[] { "", "", "", R.A.reason, R.A.reason, R.A.reason, R.C.reason, R.A.reason,
                ...
                "이분탐색 같아서 풀었는데 어떤 점에서 틀린건지 못 찾겠다.", "모듈러 연산에 대해 전혀 몰랐다.","Stack에 대해서..." ,"메모리 초과가 나오는데 아직 이유를 모르겠다.","분류 안나오는 문제에서 명확하게 구현할 방법을 떠올리지 못했다.","구현 방법을 떠올리지 못함","다시 풀어볼 것"};
