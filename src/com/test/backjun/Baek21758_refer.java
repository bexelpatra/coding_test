...
public class Baek21758_refer {
    ...
    public long test(String arg) throws Exception{
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        if(arg!=null){
            br = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(arg.getBytes())));
        }
		StringTokenizer st;
	...
	public static void main(String[] args) throws IOException {
        ...
        if(args[0]!=null){
            br = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(args[0].getBytes())));
        }
		StringTokenizer st;
